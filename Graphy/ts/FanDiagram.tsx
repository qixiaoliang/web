            ...
            <div
                ...
                <span
                    style={ {
                        ...
                        fontSize: '12px',
                        borderRadius: '6px',
                        background: hoverItem >= 0 ? describes[ hoverItem ].color : 'transparent',
                        transition:'background 1s ease',
                        color: 'white'
                    } }
                    ref={ r => { if ( r ) this.hoverTextElm = r } }>
                    {
                ...
                <svg
                    ...
                    height={ size + paddingTop * 5 }>
                    {
                        describes.map( ( item, i ) => {
                            ...
                            return (
                                <g
                                    transform={ `translate(${ paddingLeft },${ paddingTop * 2 })` }
                                    key={ i }
                                    onMouseOver={
                                        () => {
                                            this.setState( {
                                    ...
                                    <text
                                        ...
                                        fontWeight="500"
                                        textAnchor={
                                            ( 0 <= lineDeg && lineDeg <= 90 ) || ( 270 <= lineDeg ) ?
                                                'start' : 'end'
                                        }
                                        fill={ item.color }
                                        x={
